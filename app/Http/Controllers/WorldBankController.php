    ...
    public function index(Request $request)
    {
        ...
        $economyData = $countries->map(function (Country $country): array {
            return [
                ...
                'population_year' => $country->population_data_year,
                'inflation' => $country->inflation_rate,
                'inflation_year' => $country->inflation_data_year,
                'exports' => $country->exports_value,
                'exports_year' => $country->exports_data_year,
                'imports' => $country->imports_value,
                'imports_year' => $country->imports_data_year,
                'growth' => $country->gdp_growth,
                'growth_year' => $country->growth_data_year,
                'trade' => $country->trade_percentage,
                'trade_year' => $country->trade_data_year,
                'synced_at' => $country->world_bank_synced_at,
            ];
        });
