...
<div class="card card-outline card-primary">
    ...
    @if($ports->hasPages())<div class="card-footer clearfix">{{ $ports->links('pagination::bootstrap-4') }}</div>@endif
</div>
@stop
